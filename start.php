...
<form action="testreg.php" method="post" class="form-signin" id="form">
              ...
              <input type="login" id="forlogin" class="form-control" placeholder="Email address" required autofocus name="login">
              <label for="forpassword" class="sr-only">Password</label>
              <input type="password" id="forpassword" class="form-control" placeholder="Password" required name="password">
...
<a href="reg.php">Registration</a>
    ...
    echo "You logged in as ".$_SESSION['login']."<br><a  href='en/index.php'>You can use this link to proceed</a>";
    }
    ?>
</div>
    </div>
